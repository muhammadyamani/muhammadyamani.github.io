...
#pi_creature_dir_maybe = os.path.join("/Users/muhammad/manim/manimlib/files/PiCreatures_plain.svg")
#if os.path.exists(pi_creature_dir_maybe):
#
PI_CREATURE_DIR = os.path.join(MEDIA_DIR, "assets", "ResistorCreature")
#else:
#    PI_CREATURE_DIR = os.path.join("/Users/muhammad/manim/manimlib/files/PiCreatures_plain.svg")

PI_CREATURE_SCALE_FACTOR = 1
...
class ResistorCreature(SVGMobject):
    CONFIG = {
        "color": WHITE,
        "file_name_prefix": "ResistorCreature",
        "stroke_width": 0,
        "stroke_color": BLUE,
        "fill_opacity": 1.0,
        "height": 2,
    ...
    def align_data(self, mobject):
        ...
        if isinstance(mobject, ResistorCreature):
            self.mode = mobject.get_mode()

    def name_parts(self):
        self.a = self.submobjects[A_INDEX]
        self.b = self.submobjects[B_INDEX]
        self.c = self.submobjects[C_INDEX]
        self.d = self.submobjects[D_INDEX]
        self.e = self.submobjects[E_INDEX]
        self.f = self.submobjects[F_INDEX]
    #    self.g = self.submobjects[G_INDEX]
    #    self.h = self.submobjects[H_INDEX]
...
class PiCreatureBubbleIntroduction(AnimationGroup):
    CONFIG = {
        ...
        "bubble_kwargs": {},
        "content_introduction_class": DrawBorderThenFill,
...
class ResistorCreatureSays(PiCreatureBubbleIntroduction):
    CONFIG = {
        "target_mode": "speaking",
        "bubble_class": SpeechBubble,
    }
